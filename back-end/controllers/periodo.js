...
controller.listar = async (req, res) => {
    try {
        ...
        let dados = await Periodo.find().populate('criatura', 'nome')
        res.send(dados)
    }
    catch (erro) {
        //caso dê erro
...
controller.obterUm = async (req, res) => {
    ...
    let obj = await Periodo.findById(id) //Capturando o parametro id
...
controller.atualizar = async (req, res) => {
    try {
        ...
        let obj = await Periodo.findByIdAndUpdate(id, req.body)
...
controller.excluir = async (req, res) => {
    try {
        ...
        let obj = await Periodo.findByIdAndDelete(id)
